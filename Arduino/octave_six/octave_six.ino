...
void loop() {
  if (x == 0) {
    analogWrite(A0, (buff_2[write_location] + buff_3[write_location]) / 2);
    write_location++;
    ...
    analogWrite(A0, buff_3[write_location]);
    write_location++;
    ...
    analogWrite(A0, (buff_1[write_location] + buff_3[write_location]) / 2);
    write_location++;
    ...
    analogWrite(A0, buff_1[write_location]);
    write_location++;
    ...
    analogWrite(A0, (buff_2[write_location] + buff_1[write_location]) / 2);
    write_location++;
    ...
    analogWrite(A0, buff_2[write_location]);
    write_location++;
