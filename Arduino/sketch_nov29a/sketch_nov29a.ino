...
#define armed false                                                       // trigger and pushbutton state
...
// adjustable variables read
bool  DisplayMode = channeled;                                    
int   Beams = 1;                                                         // number of beams       // 'superimposed' or 'channeled'
ul    SampleInterval = .01;                                              // units: msecs * 10; 0.1 <= SampleInterval
bool  SweepMode = continuous;                                             // 'continuous' or 'triggered'
ul    TriggeredSweepInterval = 400000;                                    // total sweep time, units: seconds * 10,000
float TriggerDirection = rising;                                         // 'rising' or 'falling'
float TriggerVolts = 0;                                                // trigger vdc; 0 <= TriggerVolts <= 5
